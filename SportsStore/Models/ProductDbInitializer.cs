    ...
    public class ProductDbInitializer : DropCreateDatabaseAlways<ProductDbContext>
    {
        protected override void Seed(ProductDbContext context)
        {
            List<Product> products = new List<Product>
            {
                ...
                new Product {Name = "Stadium", Description="Flat packed 35,000 all seater stadium", Category="Soccer", Price=79500m },
                new Product {Name = "Thinking Cap", Description="Improve your brain efficiency by 75%", Category="Chess", Price=16m },
                new Product {Name = "Unsteady Chair", Description="Give your opponent a disadvantage", Category="Chess", Price=29.95m },
